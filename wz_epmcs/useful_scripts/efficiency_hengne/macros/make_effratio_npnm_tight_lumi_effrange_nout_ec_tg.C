
{
  ...
  TFile* fdt = new TFile("rootfiles/fiteff_npnm_data_tight_lumi_effrange_nout_ec_tg.root");
  TFile* fmc = new TFile("rootfiles/effhists_npnm_fullmc_tight_lumi_effrange_nout_ec_tg.root");
  TFile* fout = new TFile("rootfiles/effratio_npnm_tight_lumi_effrange_nout_ec_tg.root", "recreate");
  ...
  hratio_dt_mc->GetXaxis()->SetTitle("InstLumi");
