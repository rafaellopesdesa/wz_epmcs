
{
  ...
  TFile* fdt = new TFile("rootfiles/fiteff_npnm_data_loose_setlumi_effrange_nout_ec_tg.root");
  TFile* fmc = new TFile("rootfiles/effhists_npnm_fullmc_loose_setlumi_effrange_nout_ec_tg.root");
  TFile* fout = new TFile("rootfiles/effratio_npnm_loose_setlumi_effrange_nout_ec_tg.root", "recreate");
