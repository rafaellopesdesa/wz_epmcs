...

{
  ...
  TFile* flos = new TFile("rootfiles/effratio_npnm_loose_set_effrange_nout_ec_tg.root");  
  TFile* ftig = new TFile("rootfiles/effratio_npnm_tight_set_effrange_nout_ec_tg.root");  
  TFile* fout = new TFile("rootfiles/compare_npnm_tight_loose_set_effrange_nout_ec_tg.root", "recreate");
