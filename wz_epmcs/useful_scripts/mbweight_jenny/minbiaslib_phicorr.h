...
#ifndef minbiaslib_phicorr_h
#define minbiaslib_phicorr_h
...
public :
   ...
   minbiaslib_phicorr(const char* filelist);
   virtual ~minbiaslib_phicorr();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree);
   virtual void     Loop(TString name, double rmspow, double zerofrac, TString rootfile1);
   virtual void     runmain(TString name, double rmspow, double zerofrac, TString rootfile1);
...
#ifdef minbiaslib_phicorr_cxx
minbiaslib_phicorr::minbiaslib_phicorr(const char* filelist) : setbins(50), setmax(100.), setmin(0.)
{
...
minbiaslib_phicorr::~minbiaslib_phicorr()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t minbiaslib_phicorr::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t minbiaslib_phicorr::LoadTree(Long64_t entry)
{
...
void minbiaslib_phicorr::Init(TTree *tree)
{
...
Bool_t minbiaslib_phicorr::Notify()
{
...
void minbiaslib_phicorr::Show(Long64_t entry)
{
...
Int_t minbiaslib_phicorr::Cut(Long64_t entry)
{
...
#endif // #ifdef minbiaslib_phicorr_cxx
